...
# Go2W config: Unitree delayed-PD legs + implicit velocity-controlled wheels.
GO2W_CFG_UNITREE = UnitreeArticulationCfg(
    spawn=UnitreeUrdfFileCfg(
        asset_path=f"{ISAACLAB_ASSETS_DATA_DIR}/go2w/urdf/go2w_description.urdf",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.45),
        joint_pos={
...
GO2W_CFG_UNITREE_D435I = GO2W_CFG_UNITREE.copy()
GO2W_CFG_UNITREE_D435I.spawn = GO2W_CFG_UNITREE.spawn.replace(
    asset_path=f"{ISAACLAB_ASSETS_DATA_DIR}/go2w/urdf/go2w_d435i.urdf",
)
