...
# Gamepad teleop (Logitech F710 in X/Xbox mode; 1 env, real-time)
# Left stick: lin_x/lin_y | Right stick: yaw | X: camera follow | A: reset
python scripts/rsl_rl/play_gamepad.py --task=RobotLab-Go2-v0
```
